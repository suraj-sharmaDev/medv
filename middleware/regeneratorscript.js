...
function changeContentInView(){
	...
	prescriptionView = document.getElementById("prescription-div");
	...
	//second step is to populate the prescription image list
	if(Object.keys(_localStorage.uploadImage).length > 0){
		prescriptionImages = _localStorage.uploadImage;
		for(var key in prescriptionImages){
			var spanMain = document.createElement("SPAN");
			var spanChild = document.createElement("SPAN");
			spanMain.setAttribute("class", "pip");

			var img = document.createElement("IMG");
			img.setAttribute("class", "imageThumb");
			img.setAttribute("id", key);
			img.setAttribute("src", prescriptionImages[key]);
